...
public class ServerGame extends Application {
    ...
    public void Server() throws IOException, ClassNotFoundException{
        ...
        ServerSocket slisten = new ServerSocket(16868); //porta do processo
        ...
        dadosDoJogo.setPlayerServerName(jogador.getNome());
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        primaryStage.setTitle("Jogo da Forca - Server");
            ...
            public void handle(MouseEvent event) {
                ...
                if (acertou == true) {
                    ...
                    try {
                        ...
                        dadosDoJogo.setPlayerServerScore(dadosDoJogo.getPlayerServerScore() + 20);
                ...
                for (Potion p : pocoes) {
                    if (p.checarMouse((int) event.getX(), (int) event.getY()) == true) {
                        ...
                        if(!pal.tentaLetra(p.getAcento())){
                            dadosDoJogo.setIsServerTurn(false);
                            if(dadosDoJogo.getPlayerServerScore() >= 5){
                                dadosDoJogo.setPlayerServerScore(dadosDoJogo.getPlayerServerScore() - 5);
                            }
